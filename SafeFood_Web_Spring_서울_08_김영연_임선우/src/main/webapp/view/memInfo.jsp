	...
	<div class="container wrapper mx-auto">
		<div class="mx-auto text-center">
			...
			<div class="row justify-content-center">
				<button class="btn btn-lg  rgba-green-strong" type="button" onclick = "location.href = 'updateForm.mem' ">회원정보 수정</button>
				<button class="btn btn-lg  rgba-green-strong" type="button" onclick = "location.href = '#'">회원목록 보기</button>
			</div>
		</div>
	</div>
	</main>
